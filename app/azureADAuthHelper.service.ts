...
import { SvcConsts } from "./serviceConstants";
...
export class AzureADAuthHelper {
	...
	constructor() {
		console.log("AuthHelper.constructor called");
	...
	login() {
		console.log("AuthHelper.login called");
	...
	private getAccessToken() {
		console.log("AuthHelper.getAccessToken called");
